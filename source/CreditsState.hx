...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
            ...
            ['RexDoesStuff', 'rex', 'hi im rex and i made FUCKING EVERYTHING (except song n code) I WANT TO DIEEE', 'https://twitter.com/RexDoesStuff', '4300A0'],
            ['deltom', 'deltom', 'made funny song', 'https://www.youtube.com/c/jusstomeone', '4300A0'],
			[''],
